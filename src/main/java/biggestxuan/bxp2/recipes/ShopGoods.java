...
public enum ShopGoods {
    ...
    f5(BxP2.getStack("draconicevolution:large_chaos_frag"),11,95),
    ...
    qf5(BxP2.getStack("thermal:upgrade_augment_1"),2,4f),
    q55(BxP2.getStack("thermal:upgrade_augment_2"),2,6.5f),
    f655(BxP2.getStack("thermal:upgrade_augment_3"),2,10.5f),
    f65(BxP2.getStack("thermalendergy:endergy_upgrade_1"),2,14.5f),
    qfg55(BxP2.getStack("thermalendergy:endergy_upgrade_2"),3,20f),
    q655(BxP2.getStack("thermalendergy:endergy_upgrade_3"),4,26.5f),
    ...
    fa3(BxP2.getStack("bxp2:chaos_health_scroll"),10,25f),
    ajuf(BxP2.getStack("bxp2:xp_limit_gem"),3,15,true),
    aihf(BxP2.getStack("bxp2:xp_gem"),3,15,true),
    qqb(BxP2.getStack("bxp2:chaos_crystal_scroll"),10,25f),
    iahf(BxP2.getStack("bxp2:oumang_upgrade"),5,35.5f),
    iahaf(BxP2.getStack("bxp2:bx_upgrade"),5,30.5f),
    ioaw(BxP2.getStack("bxp2:ou_gold_upgrade"),5,44.5f),
    iawur(BxP2.getStack("bxp2:ouhuang_upgrade"),6,51.5f),
   ...
   // aihhay(BxP2.getTconstructCreative("souls"),0,12.5f,true),
    //IAU(BxPItems.CREATIVE_ABILITY_SKULL.get().getDefaultInstance(),0,15f,true),
    ...
    ihf(BxP2.getStack("sophisticatedbackpacks:stack_upgrade_tier_2"),0,4.5f),
    wiuab(BxP2.getStack("sophisticatedbackpacks:stack_upgrade_tier_3"),0,8f),
    alf(BxP2.getStack("sophisticatedbackpacks:stack_upgrade_tier_4"),0,15f),
    ...
    tij(BxP2.getStack("projecte:condenser_mk1"),11,125f),
    t3ij(BxP2.getStack("projecte:condenser_mk2"),11,133f),
    ;
