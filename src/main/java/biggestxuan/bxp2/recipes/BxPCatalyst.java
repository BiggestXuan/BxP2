...
public class BxPCatalyst{
    ...
    public BxPCatalyst(ItemStack stack, double speedRate, double energyRate,ADAPT adapt){
        this(stack,speedRate,energyRate,1,1,1,1,new ADAPT[]{adapt});
    }
    ...
    public enum ADAPT{
        BX_UNSTABLE_FURNACE,BX_FURNACE,BX_ENCH_FURNACE,ALL,NONE,CAISEED
    }
    ...
    public enum Catalysts{
        ...
        ESS_5(new BxPCatalyst(BxP2.getStack("mysticalagriculture:supremium_essence"),0.51,0.57,true)),
        ESS_4(new BxPCatalyst(BxP2.getStack("mysticalagriculture:imperium_essence"),0.69,0.71,true)),
        ...
        ARCANE(new BxPCatalyst(BxP2.getStack("rats:arcane_technology"),0.5,0.5,ADAPT.CAISEED)),
        BRAIN(new BxPCatalyst(BxP2.getStack("rats:psionic_rat_brain"),0.5,0.5,ADAPT.CAISEED)),
        WING(new BxPCatalyst(BxP2.getStack("rats:biplane_wing"),0.5,0.5,ADAPT.CAISEED)),
        WHEEL(new BxPCatalyst(BxP2.getStack("rats:dutchrat_wheel"),0.5,0.5,ADAPT.CAISEED)),
        //OU_GOLD(new BxPCatalyst(BxP2.getStack("bxp2:ou_gold_ingot"),0.66,0.66,ADAPT.CAISEED)),
        PCB(new BxPCatalyst(BxP2.getStack("pneumaticcraft:unassembled_pcb"),0.7,0.7,ADAPT.CAISEED)),
        HEART_INGOT(new BxPCatalyst(BxP2.getStack("ad_astra:calorite_ingot"),0.6,0.6,ADAPT.CAISEED))
        ;
