...
public class Config
{
    ...
    {
        return obj instanceof final String itemName && ForgeRegistries.ITEMS.containsKey(BxP2.RL(itemName));
    }
    ...
    static void onLoad(final ModConfigEvent event)
    {
        ...
        items = ITEM_STRINGS.get().stream()
                .map(itemName -> ForgeRegistries.ITEMS.getValue(BxP2.RL(itemName)))
