 ...
 * 2025/4/29
 */
public class KillCrystalItem extends BxPDraconicGuardianItem {
    @Override
    protected boolean doSomething(Player player, Level level, @Nonnull DraconicGuardianEntity dragon) {
        ...
        if(crystal == null){
            Utils.sendMessage(player, BxP2.tr("message.no_crystal"));
            return false;
        }
        crystal.kill();
        return true;
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        p_41423_.add(BxP2.tr("tooltip.draconic.kill_crystal"));
    }
}
