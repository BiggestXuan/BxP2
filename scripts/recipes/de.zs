...
public function difficultyRecipe(input as IIngredient,input1 as IIngredient) as void{
    ...
    DEFusionRecipe(input1,[<item:draconicevolution:chaotic_core>,<item:draconicevolution:chaotic_core>,<item:draconicevolution:chaotic_core>,<item:draconicevolution:chaotic_core>,<item:mekanism_extras:alloy_spectrum>,<item:mekanism_extras:alloy_spectrum>],<item:bxp2:chaotic_ingot>,3,10000000000000);
}
